    ...
    public boolean preHandle(HttpServletRequest request, HttpServletResponse response, Object handler) throws Exception {
        ...
        if(CheckOut==null){
            ...
            if(checkflag){
                ...
                String s=client.doPost("http://127.0.0.1:8080/SSO/user/check",map,"UTF-8");
                if(!"".equals(s) && null!=s){//验票成功
                    ...
                    String url = "http://127.0.0.1:8080/SSO/user/index?appid="+InterceptorUtil.getaAppId()+"&requestUrl="+request.getRequestURI();
