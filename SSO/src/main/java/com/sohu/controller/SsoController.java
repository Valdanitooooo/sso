...
//            return "user/repeatLogin";
        ...
        User findUser = this.userService.userLogin(user);
        if (user == null) {
            return "login";
        }
        
        long userid = findUser.getUserId();
        if (this.userStateDao.getUser(userid)) {
//            return "user/repeatLogin";
        }
        
        this.userStateDao.setUser(userid);
        App app = this.userService.getAppById(appid);
        CheckOut checkOut = this.userService.getCheckOut(userid);
        this.ticketDao.setTicket(userid, checkOut.getTicket());
